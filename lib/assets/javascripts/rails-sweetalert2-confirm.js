...
var sweetAlertConfirm = function(event) {
  ...
  var remoteSubmit =
    sweetAlertConfirmDefaults.remote || $linkToConfirm.data('remote') || $linkToConfirm.data('swal').remote || false
  ...
  function afterConfirmCallback() {
    if (afterConfirm) {
      window[afterConfirm]($railsLink, event);
      return false
    };
  ...
  function afterDenyCallback() {
    if(afterDeny) {
      window[afterDeny]($railsLink, event)
      return false
    }
  };
  ...
  var afterDeny = sweetAlertConfirmDefaults.afterDeny || $linkToConfirm.data('swal').after_deny || null
